        ...
        <div className=''>
            ...
            <div className='form__container'>
                <form action="" method="post">
                    ...
                    <label htmlFor="" className='form__label'>Título</label>
                    <input className="input__form-text" type="text" placeholder='Pont tu título...' />
                    <label htmlFor="" className='form__label'>Autor</label>
                    <input className="input__form-text" type="text" placeholder='Pon el autor...' />
                    <label htmlFor="" className='form__label'>Documentos</label>
                    <CloudinaryUpload />
                    <label htmlFor="" className='form__label'>Contenido</label>
                        ...
                        <div className="row">
                            <div className="col">
                                ...
                                <div className="third box">
                                    <button type="button" onClick={() => handleAlignmentClick('left')}>
                                        <FaAlignLeft />
                                    </button>
                                    <button type="button" onClick={() => handleAlignmentClick('center')}>
                                        <FaAlignCenter />
                                    </button>
                                    <button type="button" onClick={() => handleAlignmentClick('right')}>
                                        <FaAlignRight />
                                    </button>
                                </div>
                                <div className="fourth box">
                                    <button type="button">aA</button>
                                    <button type="button" onClick={() => handleTextColorChange('text-slash')}>
                                        <FaAlignRight />
                                    </button>
                    ...
                    <Link to='/blog/create/publish' className='button form__button'>Publish</Link>
                </form>
            </div>
        </div>
    )
